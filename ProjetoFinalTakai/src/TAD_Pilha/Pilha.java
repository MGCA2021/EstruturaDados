    ...
    void selecionarOpcao(short selecionador){
        switch (selecionador) {
            case 0:
                ...
                break;
            case 1:
            	System.out.println("\nPilha basicamente é a mesma definição de uma Pilha de pratos, o Último que entra é o \r\n"
            			+ "primeiro que sai, Pilhas são consideradas a estrutura de dados mais simples\r\n"
            			+ "Assim, uma pilha permite acesso a apenas um item de dados - o último inserido. \r\n"
            			+ "Numa pilha, a manipulação dos elementos é realizada em apenas uma das \r\n"
            			+ "extremidades, que é o topo, em oposição a outra extremidade, que é a base.\r\n"
            			);
                break;
            case 2:
