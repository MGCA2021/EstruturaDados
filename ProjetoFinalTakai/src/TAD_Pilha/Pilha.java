    ...
    void selecionarOpcao(short selecionador){
        switch (selecionador) {
            case 0:
                ...
                break;
            case 1:
            	System.out.println("\nPilha basicamente é a mesma definição de uma Pilha de pratos, o Último que entra é o primeiro que sai, Pilhas são consideradas a estrutura de dados mais simples\n");
                break;
            case 2:
