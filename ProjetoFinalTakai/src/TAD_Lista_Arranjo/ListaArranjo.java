    ...
    void selecionarOpcao(short selecionador){
        switch (selecionador) {
            case 0:
                ...
                break;
            case 1:
    			System.out.println("\nLista Arranjo é uma lista onde armazena N elementos, armazenando em uma certa ordem linear, onde é possível se referir aos elementos da lista como 1,2,3...,\nO 1 elemento da lista tem índice = 0 e  ultimo n -1 pode determinar um certo tamanho pra lista size()\n");
